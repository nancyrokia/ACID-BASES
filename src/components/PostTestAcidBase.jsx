...
const QUESTIONS = [
    ...
    answer: 1 // It turns red
  },
  {
    q: 'Why does red litmus paper change colour in a basic solution?',
    options: [
      'Bases destroy the paper',
      'Bases remove hydrogen ions from the dye',
      'Bases increase temperature',
      'Bases add colour to the paper'
    ],
    answer: 1 // Bases remove hydrogen ions from the dye
  },

  // ➕ NEW QUESTIONS

  {
    q: 'If both red and blue litmus papers show no colour change, the solution is most likely:',
    options: [
      'Acidic',
      'Basic',
      'Neutral',
  ...
  {
    q: 'Which observation correctly identifies a base?',
    options: [
      'Blue litmus turns red',
      'Red litmus turns blue',
      'Both litmus papers turn green',
      'Litmus dissolves in solution'
    ],
    answer: 1 // Red litmus turns blue
  },
  {
    q: 'Why is litmus paper considered a chemical indicator?',
    options: [
      'It reacts violently with acids',
      'It measures pH numerically',
      'It changes colour in response to acids and bases',
      'It neutralizes solutions'
    ],
    answer: 2 // It changes colour in response to acids and bases
    },
