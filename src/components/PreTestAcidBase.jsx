...
const QUESTIONS = [
  {
    q: 'What is the purpose of using litmus paper?',
    options: [
      'To measure the temperature of a solution',
      'To determine whether a solution is acidic or basic',
      'To increase the concentration of a solution',
      'To observe evaporation'
    ],
    answer: 1 // To determine whether a solution is acidic or basic
  },
  {
    q: 'What colour does blue litmus paper turn in an acidic solution?',
    options: [
      'Blue',
      'Green',
      'Red',
  ...
  },
  {
    ...
    answer: 0 // It turns blue
  },
  {
    q: 'Which type of solution does NOT change the colour of litmus paper?',
    options: [
      'Acidic solution',
      'Basic solution',
      'Neutral solution',
    ...
    answer: 2 // Neutral solution
  },
  {
    q: 'Why should used litmus paper be disposed of properly?',
    options: [
      'It can be reused immediately',
      'It may be contaminated with chemicals',
      'It improves experimental accuracy',
      'It changes colour back automatically'
    ],
    answer: 1 // It may be contaminated with chemicals
  }
];
