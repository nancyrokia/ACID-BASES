    ...
    <aside style={{
      ...
      <div style={{
        ...
        {experimentStep < 1 ? (
          ...
          >
            <img src='/resources/petridish.png'
              alt="Petri dish"
              style={{ position: 'relative', width: 68, height: 52 }}>
            </img>
        ...
        {experimentStep < 2 ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, opacity: 0.3 }}>
            <img src='/resources/potato.png'
              alt="Scooped Potato"
              style={{
                position: 'relative', width: 68, height: 52,
                opacity: 0.8,
                filter: 'grayscale(80%) brightness(0.6)',
              }}>
            </img>
          ...
          <div style={{
            ...
            {tapFilling && (
              <div style={{
                ...
                left: 66,
                width: 8,
                height: DISH_OUTER_H - (beakerWaterLevel * 2),
                backgroundColor: '#4299e1',
                WebkitMaskImage: 'radial-gradient(circle, black 30%, transparent 70%)',
                WebkitMaskSize: '100% 20px',
                boxShadow: '0 0 10px rgba(66,153,225,0.6)',
                animation: 'droplets 0.4s linear infinite, wobble 0.2s ease-in-out infinite',
                zIndex: 2,
                opacity: 0.8,
              }} />
            )}
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: 'calc(100vh - 6em)', overflow: 'hidden' }}>
      ...
      <style>{`
        ...
        @keyframes droplets {
          ...
          to {
            -webkit-mask-position: 0 30px; /* Moves the mask down */
          }
        }
        ...
        @keyframes wobble {
          ...
          50% { 
            transform: translateX(1px) scaleX(0.85); /* Subtle organic shivering */
          }
        }
        * {
